...
namespace DustInTheWind.Kinoko.Tests.Framework.Utils.MathTests
{
    ...
    public class AverageListTests
    {
        ...
        {
            double actual = Math.Average(new List<double> { 13 });
        ...
        {
            double actual = Math.Average(new List<double> { 13.5 });
        ...
        {
            double actual = Math.Average(new List<double> { 10, 15 });
        ...
        public void throws_when_list_is_null()
        {
            try
            {
                Math.Average(null as List<double>);
            }
