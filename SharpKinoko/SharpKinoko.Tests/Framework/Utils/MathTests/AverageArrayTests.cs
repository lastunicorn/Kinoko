...
namespace DustInTheWind.SharpKinoko.Tests.Framework.Utils.MathTests
{
    ...
    public class AverageArrayTests
    {
        ...
        {
            double actual = DustInTheWind.SharpKinoko.Utils.Math.Average(new double[] { 13 });
        ...
        {
            double actual = DustInTheWind.SharpKinoko.Utils.Math.Average(new double[] { 13.5 });
        ...
        {
            double actual = DustInTheWind.SharpKinoko.Utils.Math.Average(new double[0]);
        ...
        {
            double actual = DustInTheWind.SharpKinoko.Utils.Math.Average(new double[] { 10, 15 });
        ...
        public void throws_when_array_is_null()
        {
            try
            {
                DustInTheWind.SharpKinoko.Utils.Math.Average(null as double[]);
            }
